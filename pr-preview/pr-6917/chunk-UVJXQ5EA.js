...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-SXAN7HM7.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-XMCEE7FI.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-SKJ3SN7B.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-TAIRWVRP.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-VRCD77CN.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-FVFLDRH5.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-RW5I6B66.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-33EJ4MRH.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-T2DIQV7E.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-SUF6RIOH.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-SU7QD6EQ.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-UYF64DQ6.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "269720f";
        const gitBranch = "test/array-formula-spill-test-wait-for-sync";
        const buildTime = "2026-05-18T11:49:21.348Z";
