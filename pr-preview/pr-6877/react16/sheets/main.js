...
import "../chunk-TPFIEUG5.js";
import "../chunk-ADIOZSYH.js";
import {
...
import "../chunk-6DUPQJDW.js";
import {
  UniverSheetsThreadCommentPlugin
} from "../chunk-EIUJT4UX.js";
import "../chunk-IHNK4XEA.js";
import {
  en_US_default
...
import "../chunk-U52XXWI5.js";
import {
  UniverDebuggerPlugin
} from "../chunk-JQGMG2JB.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-DMCPYBQY.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-H5S7DFGA.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
