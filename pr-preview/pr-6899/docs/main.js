...
function KeywordInputPlaceholder({ popup }) {
...
function QuickInsertPlaceholder() {
  const localeService = useDependency(LocaleService);
...
function QuickInsertButton({ className = "" }) {
  const docQuickInsertPopupService = useDependency(DocQuickInsertPopupService);
  const univerInstanceService = useDependency(IUniverInstanceService);
...
function DocThreadCommentPanel() {
  const univerInstanceService = useDependency(IUniverInstanceService);
