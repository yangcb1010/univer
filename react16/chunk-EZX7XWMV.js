...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-VY6B46XX.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-KI6L7MVA.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-HXL6D7XY.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-YTPMZPID.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-W5XDKKYB.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-CDGVAJQD.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-IMYPCC6P.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-ANWEAIBR.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-FH2LSBJQ.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-XQNO25UN.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-J6T3ZWWS.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-TCEUZHUC.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "7f53a7e";
        const gitBranch = "dev";
        const buildTime = "2026-05-13T10:54:50.792Z";
