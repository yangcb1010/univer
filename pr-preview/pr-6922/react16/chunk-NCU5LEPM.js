...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-V7OIW2SK.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-MKSQGTKK.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-UNBEI7M3.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-BZA6ZXXG.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-2SBLN3MG.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-7U7EGOMX.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-QS6STPCU.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-LP66QJ5H.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-EBAJ2N3B.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-ECAMXUCB.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-6AMYKNXN.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-Z6TAXW2Z.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "e3f35c9";
        const gitBranch = "fix/outline-ui-1";
        const buildTime = "2026-05-19T10:14:28.808Z";
