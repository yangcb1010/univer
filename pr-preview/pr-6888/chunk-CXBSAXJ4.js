...
DocInterceptorService = __decorateClass([
  __decorateParam(0, Inject(DocSkeletonManagerService))
...
var RichTextEditor = (props) => {
  ...
  const docEmbeddingRef = (0, import_react19.useRef)(null);
...
var DataValidationResourceController = class extends Disposable {
  constructor(_resourceManagerService, _dataValidationModel) {
    super();
