...
var SheetsThreadCommentPopupController = class extends Disposable {
  ...
  _initMarkSelection() {
    this.disposeWithMe(this._threadCommentPanelService.activeCommentId$.pipe(debounceTime(100)).subscribe((activeComment) => {
      ...
      const worksheet = (_a = this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */)) == null ? void 0 : _a.getSheetBySheetId(subUnitId);
...
function SheetsThreadCommentCell() {
  ...
  const getSubUnitName = (id) => {
    var _a, _b, _c;
    return (_c = (_b = (_a = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */)) == null ? void 0 : _a.getSheetBySheetId(id)) == null ? void 0 : _b.getName()) != null ? _c : "";
  };
...
function SheetsThreadCommentPanel() {
  var _a;
