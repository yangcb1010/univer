...
import "../chunk-SVBMUG6V.js";
import "../chunk-PVVH3ZNM.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-QRVMEDPV.js";
import {
  UniverNetworkPlugin
...
import "../chunk-JXAKIQ2Q.js";
import {
  UniverDebuggerPlugin
} from "../chunk-ECLESK2Z.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-67DLFCL4.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-Y3MSGA7H.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
