...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-4QNK7BVU.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-DSWYVTDD.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-B5IOZZTC.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-G6USRBIK.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-4IRH7P6Y.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-YYDK2N44.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-2RCXRJJ4.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-RADTZ7ED.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-LZT23CI4.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-Y5DXQRFH.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-QTXGXOS6.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-PG4QJKGI.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "90c6d24";
        const gitBranch = "pxp/05061747";
        const buildTime = "2026-05-06T10:10:51.028Z";
