...
var ThreadCommentEditor = (0, import_react.forwardRef)(function ThreadCommentEditor2(props, ref) {
  var _a;
...
function ThreadCommentTree(props) {
  var _a, _b, _c;
  const {
    id,
    unitId,
...
function ThreadCommentPanel(props) {
  const {
    unitId,
    subUnitId$,
    type,
