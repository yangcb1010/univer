...
import "../chunk-ABVTX3MI.js";
import "../chunk-GCF2T5UV.js";
import {
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-6CIMJPNT.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-T22XFBYR.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
