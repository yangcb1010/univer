...
var DocAutoFormatService = class extends Disposable {
  ...
  onAutoFormat(id, params) {
    ...
    const unit = this._univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var DocMenuStyleService = class extends Disposable {
  ...
  getDefaultStyle() {
    var _a;
    const docDataModel = this._univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var BreakLineCommand = {
  ...
  handler: (accessor, params) => {
    ...
    const docDataModel = univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var DocClipboardService = class extends Disposable {
  ...
  async legacyPaste(options) {
    ...
    const currentDocInstance = this._univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var TextRange = class {
  ...
  _createOrUpdateRange(pointsGroup, left, top) {
    ...
    const OPACITY = 0.3;
    const polygon = new RegularPolygon(TEXT_RANGE_KEY_PREFIX + generateRandomId(ID_LENGTH2), {
      pointsGroup,
  ...
  _createOrUpdateAnchor(pointsGroup, docsLeft, docsTop, glyph) {
    ...
    const anchor = new Rect(TEXT_ANCHOR_KEY_PREFIX + generateRandomId(ID_LENGTH2), {
      left,
      top,
      height,
...
var RectRange = class {
  ...
  _createOrUpdateRange(pointsGroup, left, top) {
    ...
    const OPACITY = 0.3;
    const polygon = new RegularPolygon(RECT_RANGE_KEY_PREFIX + generateRandomId(ID_LENGTH3), {
      pointsGroup,
      fill: ((_a = this.style) == null ? void 0 : _a.fill) || getColor(COLORS.black, OPACITY),
      left,
      top,
...
var Editor = class extends Disposable {
   ...
   */
  focus() {
    const curDoc = this._univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
function DocHeaderFooterOptions(props) {
...
function ParagraphSetting() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "univer-mt-4 univer-text-sm univer-font-medium", children: localeService.t("doc.paragraphSetting.alignment") }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      "div",
      {
        className: clsx(`univer-mt-2 univer-box-border univer-flex univer-w-full univer-items-center univer-justify-between univer-gap-1 univer-rounded-md univer-p-1`, borderClassName),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "univer-mt-5 univer-text-sm univer-font-medium", children: localeService.t("doc.paragraphSetting.indentation") }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-mt-2 univer-flex univer-flex-col univer-gap-2.5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-gap-2.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-1 univer-flex-col univer-gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "univer-text-xs", children: [
            localeService.t("doc.paragraphSetting.left"),
            "(px)"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutoFocusInputNumber, { value: indentStart, onChange: (v) => setIndentStart(v != null ? v : 0) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-1 univer-flex-col univer-gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "univer-text-xs", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutoFocusInputNumber, { value: indentEnd, onChange: (v) => setIndentEnd(v != null ? v : 0) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-gap-2.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-1 univer-flex-col univer-gap-2", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutoFocusInputNumber, { value: indentFirstLine, onChange: (v) => setIndentFirstLine(v != null ? v : 0) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-1 univer-flex-col univer-gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "univer-text-xs", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutoFocusInputNumber, { value: hanging, onChange: (v) => setHanging(v != null ? v : 0) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "univer-mt-5 univer-text-sm univer-font-medium", children: localeService.t("doc.paragraphSetting.spacing") }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-mt-2 univer-flex univer-flex-col univer-gap-2.5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-gap-2.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-1 univer-flex-col univer-gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "univer-text-xs", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutoFocusInputNumber, { value: spaceAbove, onChange: (v) => setSpaceAbove(v != null ? v : 0) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-1 univer-flex-col univer-gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "univer-text-xs", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AutoFocusInputNumber, { value: spaceBelow, onChange: (v) => setSpaceBelow(v != null ? v : 0) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-flex-col univer-gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "univer-text-xs", children: localeService.t("doc.paragraphSetting.lineSpace") }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "univer-flex univer-gap-2.5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "univer-flex-1", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Select,
            {
...
function DocCreateTableConfirm({
  handleRowColChange,
  tableCreateParams
}) {
  const localeService = useDependency(LocaleService);
...
function OrderListTypePicker(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    ListTypePicker,
    {
      ...props,
...
function BulletListTypePicker(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    ListTypePicker,
    {
      ...props,
    ...
    activated$: new Observable((subscriber) => {
      ...
      const subscription = commandService.onCommandExecuted((c) => {
        ...
        if (c.id === RichTextEditingMutation.id) {
          const instance2 = univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
          subscriber.next(((_a2 = instance2 == null ? void 0 : instance2.getSnapshot()) == null ? void 0 : _a2.documentStyle.documentFlavor) === 2 /* MODERN */);
        }
      });
      const instance = univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var DocSelectionRenderController = class extends Disposable {
  ...
  _initialMain(unitId) {
    ...
    this.disposeWithMe(document2.onPointerDown$.subscribeEvent((evt, state) => {
      ...
      const docDataModel = this._instanceSrv.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var DocRenderController = class extends RxDisposable {
  ...
  _addNewRender() {
    ...
    scene.onMouseWheel$.subscribeEvent((evt, state) => {
      const currentDocUnit = this._univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
...
var DocsRenderService = class extends RxDisposable {
  ...
  _createRenderer(doc) {
    var _a;
    const unitId = doc.getUnitId();
    const workbookId = (_a = this._instanceSrv.getCurrentUnitForType(1 /* UNIVER_DOC */)) == null ? void 0 : _a.getUnitId();
...
var UniverDocsUIPlugin = class extends Plugin {
  ...
  _markDocAsFocused() {
    ...
    try {
      const doc = currentService.getCurrentUnitForType(1 /* UNIVER_DOC */);
      if (!doc) return;
...
function addCustomDecorationBySelectionFactory(accessor, param) {
  ...
  const docSelectionManagerService = accessor.get(DocSelectionManagerService);
  const univerInstanceService = accessor.get(IUniverInstanceService);
  const documentDataModel = propUnitId ? univerInstanceService.getUnit(propUnitId, 1 /* UNIVER_DOC */) : univerInstanceService.getCurrentUnitForType(1 /* UNIVER_DOC */);
  if (!documentDataModel) {
    return false;
  }
  const unitId = documentDataModel.getUnitId();
    ...
    this.disposeWithMe(this._commandService.onCommandExecuted((commandInfo, options) => {
      if (commandInfo.id === SetRangeValuesMutation.id && !(options == null ? void 0 : options.onlyLocal)) {
        ...
        if (cellValue) {
          ...
          const intersectsRanges = ranges.map((ruleRange) => getIntersectRange(ruleRange, range)).filter(Boolean);
...
var ListValidator = class extends BaseDataValidator {
  ...
  _getUnitAndSubUnit(currentUnitId, currentSubUnitId) {
    var _a, _b;
    const workbook = (_a = currentUnitId ? this._univerInstanceService.getUniverSheetInstance(currentUnitId) : void 0) != null ? _a : this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */);
      ...
      this._sheetInterceptorService.interceptCommand({
        ...
        getMutations: (commandInfo) => {
          ...
          if (commandInfo.id === RemoveSheetCommand.id) {
            const params = commandInfo.params;
            const unitId = params.unitId || this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getUnitId();
