...
import "../chunk-3MXRVZDB.js";
import "../chunk-VBWK755Q.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-UP6MM4GX.js";
import {
  UniverNetworkPlugin
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-Y3F2RZ4D.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-ZDNSBFAV.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
