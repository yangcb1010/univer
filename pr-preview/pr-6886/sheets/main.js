...
import "../chunk-KNBDIABF.js";
import "../chunk-FGWFOCHU.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-A52Y63JU.js";
import {
  UniverNetworkPlugin
...
import "../chunk-XZ4ZKDU6.js";
import {
  UniverDebuggerPlugin
} from "../chunk-OF4CDSPA.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-Y2Q4G5VG.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-KKAOXUYH.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
