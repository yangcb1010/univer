...
var TextInput = (props) => {
  ...
  const unitId = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getUnitId();
  const subUnitId = (_a = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getActiveSheet()) == null ? void 0 : _a.getSheetId();
...
function ColorScaleStyleEditor(props) {
  var _a;
...
function DataBarStyleEditor(props) {
  var _a;
  const { interceptorManager } = props;
  const localeService = useDependency(LocaleService);
...
function ConditionalStyleEditor(props) {
...
function FormulaStyleEditor(props) {
  var _a;
...
function HighlightCellStyleEditor(props) {
  var _a;
...
function RankStyleEditor(props) {
  var _a;
  const { onChange, interceptorManager } = props;
  const localeService = useDependency(LocaleService);
  const rule = ((_a = props.rule) == null ? void 0 : _a.type) === "highlightCell" /* highlightCell */ ? props.rule : void 0;
...
var getUnitId = (univerInstanceService) => univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getUnitId();
var getSubUnitId = (univerInstanceService) => {
  var _a;
  return (_a = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getActiveSheet()) == null ? void 0 : _a.getSheetId();
};
function RuleEdit(props) {
  ...
  const handleSubmit = () => {
    ...
    const getRanges = () => {
      const worksheet = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getActiveSheet();
      if (!worksheet) {
...
function ConditionFormattingPanel(props) {
...
var SheetsCfRenderController = class extends Disposable {
  ...
  _markDirtySkeleton() {
    var _a, _b, _c;
    const unitId = this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getUnitId();
...
var ConditionalFormattingAutoFillController = class extends Disposable {
  ...
  _initAutoFill() {
    ...
    const loopFunc = (sourceStartCell, targetStartCell, relativeRange, matrixMap, mapFunc) => {
      var _a;
      const unitId = this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getUnitId();
      const subUnitId = (_a = this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */).getActiveSheet()) == null ? void 0 : _a.getSheetId();
      if (!unitId || !subUnitId) {
        return;
      }
      const sourceRange = {
    ...
    const generalApplyFunc = (sourceRange, targetRange) => {
      var _a, _b, _c;
      const unitId = (_a = this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */)) == null ? void 0 : _a.getUnitId();
      const subUnitId = (_c = (_b = this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */)) == null ? void 0 : _b.getActiveSheet()) == null ? void 0 : _c.getSheetId();
  ...
  const clearRangeEnable$ = new Observable((subscriber) => merge(
    ...
    new Observable((commandSubscribe) => {
      const disposable = commandService.onCommandExecuted((commandInfo) => {
        var _a;
        const { id, params } = commandInfo;
        const unitId = (_a = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */)) == null ? void 0 : _a.getUnitId();
...
var DataValidationDropdownManagerService = class extends Disposable {
  ...
  _getDropdownByCell(unitId, subUnitId, row, col) {
    const workbook = unitId ? this._univerInstanceService.getUnit(unitId, 2 /* UNIVER_SHEET */) : this._univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */);
    if (!workbook) {
      return;
    }
...
function getSheetIdByName(univerInstanceService, unitId, name) {
  ...
  return ((_d = (_c = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */)) == null ? void 0 : _c.getSheetBySheetName(name)) == null ? void 0 : _d.getSheetId()) || "";
}
...
function DataValidationItem(props) {
...
function DataValidationList(props) {
  ...
  const getDvRulesByPermissionCorrect = (rules2) => {
    const workbook2 = univerInstanceService.getCurrentUnitForType(2 /* UNIVER_SHEET */);
    const worksheet2 = workbook2.getActiveSheet();
...
function BaseFormulaInput(props) {
