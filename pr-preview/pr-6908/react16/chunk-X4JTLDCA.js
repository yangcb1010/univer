...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-ZXV25SCB.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-TJWF4FDB.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-3N2KBRXQ.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-BYX4MZZL.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-LLV2RAER.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-OI3NTUDU.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-RFLIYMV6.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-7NXSBF6U.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-ZADEZMTT.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-BNOFDOVQ.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-XGCSQZWE.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-UGGZD222.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "6674975";
        const gitBranch = "refactor/cleanup-unused-utils";
        const buildTime = "2026-05-16T06:03:00.409Z";
