...
import "../chunk-RYZDHE7E.js";
import "../chunk-GQPOS5H5.js";
import {
  UniverVue3AdapterPlugin,
  UniverWebComponentAdapterPlugin
} from "../chunk-77FJXEOW.js";
import {
  UniverNetworkPlugin
...
import "../chunk-EK6GGXMV.js";
import {
  UniverDebuggerPlugin
} from "../chunk-5JDW2XZU.js";
...
function createNewInstance() {
  ...
  setTimeout(() => {
    import("../lazy-Y6NKSYVQ.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
  }, LOAD_LAZY_PLUGINS_TIMEOUT);
  setTimeout(() => {
    import("../very-lazy-QOKRJOJZ.js").then((lazy) => {
      const plugins = lazy.default();
      univer.registerPlugins(plugins);
    });
